...
An adversary would put the generating source and reproducible export command under version control, then retire the duplicate phase scheduling left in generated core.
